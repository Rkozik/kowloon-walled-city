...
export class GUI {
  ...
  run() {
    ...
    this.gameboard.addEventListener(
      "mousedown",
      this.handleMouseDownGameboard.bind(this),
      false
    );
    this.gameboard.addEventListener(
      "mouseup",
      this.handleMouseUpGameboard.bind(this),
      false
    );
  ...
  drawNode(node) {
    switch (this.pointer) {
      ...
      case "residential":
        ...
        break;
      case "commercial":
        let commercial_residence = new CommercialResidence(
          node,
          this.tower,
          this.bank_account
        );
        ...
        break;
      case "industrial":
        let industrial_residence = new IndustrialResidence(
          node,
          this.tower,
          this.bank_account
        );
  ...
  updatePointer(pointer) {
    ...
    switch (pointer) {
      case "residential":
        cursor_styles.innerText =
          "body{cursor:url('img/gui/residential-ico.png'), pointer;}";
        break;
      case "commercial":
        cursor_styles.innerText =
          "body{cursor:url('img/gui/commercial-ico.png'), pointer;}";
        break;
      case "industrial":
        cursor_styles.innerText =
          "body{cursor:url('img/gui/industrial-ico.png'), pointer;}";
        break;
      case "lobby":
        cursor_styles.innerText =
          "body{cursor:url('img/gui/lobby-ico.png'), pointer;}";
        break;
      case "tenant":
        cursor_styles.innerText =
          "body{cursor:url('img/gui/tenant-ico.png'), pointer;}";
        break;
      case "stairs":
        cursor_styles.innerText =
          "body{cursor:url('img/gui/stairs-ico.png'), pointer;}";
        break;
      default:
        cursor_styles.innerText =
          "body{cursor:url('img/gui/pointer-ico.png'), pointer;}";
        break;
    }
